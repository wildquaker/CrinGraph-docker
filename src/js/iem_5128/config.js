...
const init_phones = [ "Project Meta V3.0 (Silicone narrow)","JM-1 Target" ], // Optional. Which graphs to display on initial load. Note: Share URLs will override this set
      ...
      site_url = 'iem_5128.html',                          // Display a configurable header at the top of the alt layout
      ...
      page_title = "CrinGraph | 5128 IEM Graph Tool",                    // Optional. Appended to the page title if share URLs are enabled
...
const  preference_bounds_name = "Preference Bounds RAW",  // Preference bounds name
       ...
       PHONE_BOOK = "../../data/iem_5128/phone_book.json",                 // Path to phone book JSON file
       ...
       default_bass_shelf = 7.5,                         // Default Custom DF bass shelf value
...
function setLayout() {
    ...
    if ( !alt_layout ) {
        applyStylesheet("../../css/iem_5128/style.css");
    } else {
        applyStylesheet("../../css/iem_5128/style-alt.css");
        applyStylesheet("../../css/iem_5128/style-alt-theme.css");
    }
}
